 ...
 * contents of CalcTheta.xs. Do not edit this file, edit CalcTheta.xs instead.
 *
...
#line 59 "CalcTheta.c"
XS(XS_CalcTheta_findLOD)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: CalcTheta::findLOD(markerA, markerB)");
    {
	char*	markerA = (char *)SvPV(ST(0),PL_na);
	char*	markerB = (char *)SvPV(ST(1),PL_na);
#line 59 "CalcTheta.xs"
	int len, i;
...
XS(XS_CalcTheta_findTheta)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: CalcTheta::findTheta(markerA, markerB)");
    {
	char*	markerA = (char *)SvPV(ST(0),PL_na);
	char*	markerB = (char *)SvPV(ST(1),PL_na);
#line 100 "CalcTheta.xs"
	int len, i;
	double rab, rba, ra, rb, rra, rrb, ta, tb, T, denom;
	char a,b;

#line 123 "CalcTheta.c"
	double	RETVAL;
#line 105 "CalcTheta.xs"
	len = strlen(markerA);
...
XS(boot_CalcTheta)
{
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("CalcTheta::findLOD", XS_CalcTheta_findLOD, file, "$$");
        newXSproto("CalcTheta::findTheta", XS_CalcTheta_findTheta, file, "$$");
    XSRETURN_YES;
}
