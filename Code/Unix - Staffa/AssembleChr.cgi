...
&PARSE;
my @values = ();
@values = FindOligos::findSts("ATATAT", "CGCGCGC", "ATATAATAATATATATTTAATT", 1, 50, 1000);
#@values = unpack ("L1000", $a);
for $i (0..15) {
	print "Perl $i = $values[$i]<BR>";
}
...
sub PLACESTS {
	...
	$| = 1;
	print "<CENTER><TABLE BGCOLOR=yellow BORDER=1><TR WIDTH=300><TD><FONT COLOR=red><H2>Long Calculation in Progress<BR>Please do not Disturb</H2></FONT></TABLE></CENTER>\n";
